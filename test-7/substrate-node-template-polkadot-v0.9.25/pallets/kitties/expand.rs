...
pub mod pallet {
        ...
        impl ::codec::Decode for Kitty {
            fn decode<__CodecInputEdqy: ::codec::Input>(
                ...
                ::core::result::Result::Ok(
                    Kitty({
                        let __codec_res_edqy = <[u8; 16] as ::codec::Decode>::decode(
                            __codec_input_edqy,
                        );
    ...
    impl ::core::clone::Clone for Kitty {
        ...
        fn clone(&self) -> Kitty {
            match *self {
                Self(ref __self_0_0) => {
                    Kitty(::core::clone::Clone::clone(&(*__self_0_0)))
                }
            }
        }
    }
    ...
    pub type NextKiityId<T> = StorageValue<
        _GeneratedPrefixForStorageNextKiityId<T>,
        KittyIndex,
        ValueQuery,
        GetDefaultValue,
    >;
        ...
        impl<T: Config> core::clone::Clone for Event<T> {
            fn clone(&self) -> Self {
                match self {
                    ...
                    Self::KittyTransfor(ref _0, ref _1, ref _2) => {
                        Self::KittyTransfor(
                            core::clone::Clone::clone(_0),
                            core::clone::Clone::clone(_1),
                            core::clone::Clone::clone(_2),
        ...
        impl<T: Config> core::cmp::PartialEq for Event<T> {
            fn eq(&self, other: &Self) -> bool {
                match (self, other) {
                    ...
                    (
                        Self::KittyTransfor(_0, _1, _2),
                        Self::KittyTransfor(_0_other, _1_other, _2_other),
                    ) => true && _0 == _0_other && _1 == _1_other && _2 == _2_other,
                    (Self::__Ignore(_0, _1), Self::__Ignore(_0_other, _1_other)) => {
                        true && _0 == _0_other && _1 == _1_other
                    }
                    (Self::KittyCreated { .. }, Self::KittyTransfor { .. }) => false,
                    (Self::KittyCreated { .. }, Self::__Ignore { .. }) => false,
                    (Self::KittyTransfor { .. }, Self::KittyCreated { .. }) => false,
                    (Self::KittyTransfor { .. }, Self::__Ignore { .. }) => false,
                    (Self::__Ignore { .. }, Self::KittyCreated { .. }) => false,
                    (Self::__Ignore { .. }, Self::KittyTransfor { .. }) => false,
                }
            }
        }
    };
        ...
        impl<T: Config> core::fmt::Debug for Event<T> {
            fn fmt(&self, fmt: &mut core::fmt::Formatter) -> core::fmt::Result {
                match *self {
                    ...
                    Self::KittyTransfor(ref _0, ref _1, ref _2) => {
                        fmt
                            .debug_tuple("Event::KittyTransfor")
                            .field(&_0)
                            .field(&_1)
                            .field(&_2)
                            .finish()
            ...
            T::AccountId: ::codec::Encode,
        {
            fn encode_to<__CodecOutputEdqy: ::codec::Output + ?::core::marker::Sized>(
                ...
                match *self {
                    ...
                    Event::KittyTransfor(ref aa, ref ba, ref ca) => {
                    ...
                    __codec_x_edqy if __codec_x_edqy
                        ...
                        ::core::result::Result::Ok(
                            ...
                            >::KittyCreated(
                                ...
                                {
                                    let __codec_res_edqy = <KittyIndex as ::codec::Decode>::decode(
                                        __codec_input_edqy,
                                    );
                                    match __codec_res_edqy {
                                        ::core::result::Result::Err(e) => {
                                ...
                                {
                                    let __codec_res_edqy = <Kitty as ::codec::Decode>::decode(
                                        __codec_input_edqy,
                                    );
                                    match __codec_res_edqy {
                                        ::core::result::Result::Err(e) => {
                            ...
                            >::KittyTransfor(
                                {
                                    ...
                                    match __codec_res_edqy {
                                        ::core::result::Result::Err(e) => {
                                            return ::core::result::Result::Err(
                                                e.chain("Could not decode `Event::KittyTransfor.0`"),
                                            );
                                        }
                                        ::core::result::Result::Ok(__codec_res_edqy) => {
                                            __codec_res_edqy
                                ...
                                },
                                {
                                    ...
                                    match __codec_res_edqy {
                                        ::core::result::Result::Err(e) => {
                                            return ::core::result::Result::Err(
                                                e.chain("Could not decode `Event::KittyTransfor.1`"),
                                            );
                                        }
                                        ::core::result::Result::Ok(__codec_res_edqy) => {
                                            __codec_res_edqy
                                ...
                                },
                                {
                                    ...
                                    match __codec_res_edqy {
                                        ::core::result::Result::Err(e) => {
                                            return ::core::result::Result::Err(
                                                e.chain("Could not decode `Event::KittyTransfor.2`"),
                                            );
                                        }
                                        ::core::result::Result::Ok(__codec_res_edqy) => {
                                            __codec_res_edqy
    ...
    const _: () = {
            ...
            T: Config + 'static,
        {
            ...
            fn type_info() -> ::scale_info::Type {
                ::scale_info::Type::builder()
                    .path(::scale_info::Path::new("Event", "pallet_kitties::pallet"))
                    .type_params(
                        <[_]>::into_vec(
                            #[rustc_box]
                            ::alloc::boxed::Box::new([
                                    ...
                                    v
                                        ...
                                        .fields(
                                            ::scale_info::build::Fields::unnamed()
                                                ...
                                                .field(|f| {
                                                    f.ty::<Kitty>().type_name("Kitty").docs_always(&[])
                                                }),
                                        )
                                        .docs_always(&[])
                                },
        ...
        impl<T> ::codec::Decode for Error<T> {
            fn decode<__CodecInputEdqy: ::codec::Input>(
                    ...
                    })?
                {
                    __codec_x_edqy if __codec_x_edqy
                        == 0usize as ::core::primitive::u8 => {
                        ::core::result::Result::Ok(Error::<T>::KittyAlreadExist)
                    }
                    __codec_x_edqy if __codec_x_edqy
                        == 1usize as ::core::primitive::u8 => {
                        ::core::result::Result::Ok(Error::<T>::KittyNotExist)
                    }
                    __codec_x_edqy if __codec_x_edqy
                        == 2usize as ::core::primitive::u8 => {
                        ::core::result::Result::Ok(Error::<T>::NotKittyOwner)
                    }
                    __codec_x_edqy if __codec_x_edqy
                        == 3usize as ::core::primitive::u8 => {
                        ::core::result::Result::Ok(Error::<T>::InvaidKittyId)
                    }
                    __codec_x_edqy if __codec_x_edqy
    ...
    const _: () = {
            ...
            T: 'static,
        {
            ...
            fn type_info() -> ::scale_info::Type {
                ::scale_info::Type::builder()
                    .path(::scale_info::Path::new("Error", "pallet_kitties::pallet"))
                    .type_params(
                        <[_]>::into_vec(
                            #[rustc_box]
                            ::alloc::boxed::Box::new([
                    ...
                    .variant(
                        ::scale_info::build::Variants::new()
                            ...
                            .variant(
                                "InvaidKittyId",
                                |v| {
                                    v.index(3usize as ::core::primitive::u8).docs_always(&[])
                                },
                            )
                            .variant(
                                "SameKittyId",
                                |v| {
                                    v.index(4usize as ::core::primitive::u8).docs_always(&[])
                                },
                            ),
                    )
            }
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn breed(
            ...
            let kitty_1 = Self::get_kitty(kitty_id_1)
                .map_err(|_| Error::<T>::InvaidKittyId)?;
        ...
        pub fn transfor(
            ...
            {
                if !(Self::kitty_owner(kitty_id) == Some(sender.clone())) {
    ...
    impl<T: Config> frame_support::traits::StorageInfoTrait for Pallet<T> {
        ...
        > {
            ...
            {
                let mut storage_info = <NextKiityId<
                    T,
                > as frame_support::traits::StorageInfoTrait>::storage_info();
                res.append(&mut storage_info);
            }
            {
                let mut storage_info = <Kitties<
                    T,
                > as frame_support::traits::StorageInfoTrait>::storage_info();
                res.append(&mut storage_info);
            }
            {
                let mut storage_info = <KittyOwner<
                    T,
                > as frame_support::traits::StorageInfoTrait>::storage_info();
                res.append(&mut storage_info);
            }
        ...
        impl<T: Config> core::fmt::Debug for Call<T> {
            fn fmt(&self, fmt: &mut core::fmt::Formatter) -> core::fmt::Result {
                match *self {
                    ...
                    Self::transfor { ref kitty_id, ref new_owner } => {
                        fmt
                            .debug_struct("Call::transfor")
            ...
            fn eq(&self, other: &Self) -> bool {
                match (self, other) {
                    ...
                    (
                        ...
                        Self::breed { kitty_id_1: _0, kitty_id_2: _1 },
                    ) => true && kitty_id_1 == _0 && kitty_id_2 == _1,
                    (
                        Self::transfor { kitty_id, new_owner },
                        Self::transfor { kitty_id: _0, new_owner: _1 },
                    ) => true && kitty_id == _0 && new_owner == _1,
                    (Self::__Ignore { .. }, Self::create { .. }) => false,
                    (Self::__Ignore { .. }, Self::breed { .. }) => false,
                    (Self::__Ignore { .. }, Self::transfor { .. }) => false,
                    (Self::create { .. }, Self::__Ignore { .. }) => false,
                    (Self::create { .. }, Self::breed { .. }) => false,
                    (Self::create { .. }, Self::transfor { .. }) => false,
                    (Self::breed { .. }, Self::__Ignore { .. }) => false,
                    (Self::breed { .. }, Self::create { .. }) => false,
                    (Self::breed { .. }, Self::transfor { .. }) => false,
                    (Self::transfor { .. }, Self::__Ignore { .. }) => false,
                    (Self::transfor { .. }, Self::create { .. }) => false,
                    (Self::transfor { .. }, Self::breed { .. }) => false,
                }
            }
        }
    };
        ...
        impl<T: Config> ::codec::Encode for Call<T> {
            fn encode_to<__CodecOutputEdqy: ::codec::Output + ?::core::marker::Sized>(
                ...
                match *self {
                    ...
                    Call::transfor { ref kitty_id, ref new_owner } => {
            ...
            fn decode<__CodecInputEdqy: ::codec::Input>(
                    ...
                    })?
                {
                    ...
                    __codec_x_edqy if __codec_x_edqy == 2u8 as ::core::primitive::u8 => {
                        ::core::result::Result::Ok(Call::<T>::transfor {
                            kitty_id: {
                                ...
                                match __codec_res_edqy {
                                    ::core::result::Result::Err(e) => {
                                        return ::core::result::Result::Err(
                                            e.chain("Could not decode `Call::transfor::kitty_id`"),
                                        );
                                    }
                                    ::core::result::Result::Ok(__codec_res_edqy) => {
                                        __codec_res_edqy
                            ...
                            new_owner: {
                                ...
                                match __codec_res_edqy {
                                    ::core::result::Result::Err(e) => {
                                        return ::core::result::Result::Err(
                                            e.chain("Could not decode `Call::transfor::new_owner`"),
                                        );
                                    }
                                    ::core::result::Result::Ok(__codec_res_edqy) => {
                                        __codec_res_edqy
    ...
    impl<T: Config> Call<T> {
        ...
        ///Create a call with the variant `transfor`.
        pub fn new_call_variant_transfor(
            kitty_id: u32,
            new_owner: T::AccountId,
        ) -> Self {
            Self::transfor {
    ...
    impl<T: Config> frame_support::dispatch::GetDispatchInfo for Call<T> {
        fn get_dispatch_info(&self) -> frame_support::dispatch::DispatchInfo {
            match *self {
                Self::create {} => {
                    let __pallet_base_weight = 10_00;
                ...
                Self::breed { ref kitty_id_1, ref kitty_id_2 } => {
                    ...
                    >>::weigh_data(&__pallet_base_weight, (kitty_id_1, kitty_id_2));
                    let __pallet_class = <dyn frame_support::dispatch::ClassifyDispatch<
                        (&KittyIndex, &KittyIndex),
                    >>::classify_dispatch(
                    ...
                    let __pallet_pays_fee = <dyn frame_support::dispatch::PaysFee<
                        (&KittyIndex, &KittyIndex),
                    >>::pays_fee(&__pallet_base_weight, (kitty_id_1, kitty_id_2));
                    frame_support::dispatch::DispatchInfo {
                        weight: __pallet_weight,
                        class: __pallet_class,
                        pays_fee: __pallet_pays_fee,
                ...
                Self::transfor { ref kitty_id, ref new_owner } => {
                    ...
                    let __pallet_weight = <dyn frame_support::dispatch::WeighData<
                        (&u32, &T::AccountId),
                    >>::weigh_data(&__pallet_base_weight, (kitty_id, new_owner));
                    let __pallet_class = <dyn frame_support::dispatch::ClassifyDispatch<
                        (&u32, &T::AccountId),
                    >>::classify_dispatch(&__pallet_base_weight, (kitty_id, new_owner));
                    let __pallet_pays_fee = <dyn frame_support::dispatch::PaysFee<
                        (&u32, &T::AccountId),
                    >>::pays_fee(&__pallet_base_weight, (kitty_id, new_owner));
                    frame_support::dispatch::DispatchInfo {
                        weight: __pallet_weight,
                        class: __pallet_class,
                        pays_fee: __pallet_pays_fee,
        ...
        fn dispatch_bypass_filter(
            ...
            match self {
                ...
                Self::transfor { kitty_id, new_owner } => {
                    ...
                    let __tracing_guard__ = __within_span__.enter();
                    frame_support::storage::in_storage_layer(|| {
                        <Pallet<T>>::transfor(origin, kitty_id, new_owner)
                            .map(Into::into)
                            .map_err(Into::into)
                    })
                }
    ...
    impl<T: Config> Error<T> {
        ...
        pub fn as_str(&self) -> &'static str {
            match &self {
                ...
                Self::KittyAlreadExist => "KittyAlreadExist",
                Self::KittyNotExist => "KittyNotExist",
                Self::NotKittyOwner => "NotKittyOwner",
                Self::InvaidKittyId => "InvaidKittyId",
    ...
    impl<T: Config> Pallet<T> {
        pub fn next_kitty_id() -> KittyIndex {
            <NextKiityId<T> as frame_support::storage::StorageValue<KittyIndex>>::get()
        }
    }
    impl<T: Config> Pallet<T> {
        pub fn kittes<KArg>(k: KArg) -> Option<Kitty>
        where
    ...
    impl<T: Config> Pallet<T> {
            ...
            KArg: frame_support::codec::EncodeLike<KittyIndex>,
        {
            <KittyOwner<
                T,
            > as frame_support::storage::StorageMap<KittyIndex, T::AccountId>>::get(k)
        }
    }
    #[doc(hidden)]
    pub struct _GeneratedPrefixForStorageNextKiityId<T>(core::marker::PhantomData<(T,)>);
    impl<T: Config> frame_support::traits::StorageInstance
    for _GeneratedPrefixForStorageNextKiityId<T> {
        ...
        const STORAGE_PREFIX: &'static str = "NextKiityId";
    }
    #[doc(hidden)]
    pub struct _GeneratedPrefixForStorageKitties<T>(core::marker::PhantomData<(T,)>);
    impl<T: Config> frame_support::traits::StorageInstance
    for _GeneratedPrefixForStorageKitties<T> {
        fn pallet_prefix() -> &'static str {
            <<T as frame_system::Config>::PalletInfo as frame_support::traits::PalletInfo>::name::<
                Pallet<T>,
            >()
    ...
    impl<T: Config> frame_support::traits::StorageInstance
    for _GeneratedPrefixForStorageKittyOwner<T> {
        fn pallet_prefix() -> &'static str {
            <<T as frame_system::Config>::PalletInfo as frame_support::traits::PalletInfo>::name::<
                Pallet<T>,
            >()
    ...
    impl<T: Config> Store for Pallet<T> {
        type NextKiityId = NextKiityId<T>;
