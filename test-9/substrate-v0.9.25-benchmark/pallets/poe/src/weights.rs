// 拷贝自 https://github.com/paritytech/substrate/blob/polkadot-v0.9.25/.maintain/frame-weight-template.hbs
...
//! HOSTNAME: `Alps-Mac-mini.lan`, CPU: `<UNKNOWN>`
